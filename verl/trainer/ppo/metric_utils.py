...
def process_validation_metrics(
    ...
    data_src2var2metric2val["HuggingFaceH4/MATH-500"]["response_length"]["mean"] = torch.mean(response_length).detach().item()
    data_src2var2metric2val["HuggingFaceH4/MATH-500"]["response_length"]["max"] = torch.max(response_length).detach().item()
    data_src2var2metric2val["HuggingFaceH4/MATH-500"]["response_length"]["min"] = torch.min(response_length).detach().item()
