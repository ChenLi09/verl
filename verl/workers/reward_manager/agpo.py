...
class AGPORewardManager:
    ...
    def __call__(self, data: DataProto, return_dict=False):
        ...
        for i in range(len(data)):
            ...
            reward_by_problem.append(reward)
            length_by_response.append(valid_response_length.item())
            if prompt_str not in problem_idx_mapping:
                problem_idx_mapping[prompt_str] = []
            problem_idx_mapping[prompt_str].append(i)
